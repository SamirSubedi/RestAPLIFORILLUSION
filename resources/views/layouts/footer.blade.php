          ...
          <div class="col-md-6 col-lg-4">
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
                <li><span class="icon icon-map-marker"></span><span class="text">Lalitpur, Nepal</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">01-45454s0</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">sadasdas@com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="ftco-footer-widget mb-5 ml-md-4">
              ...
              <li><a href="/"><span class="ion-ios-arrow-round-forward mr-2"></span>Home</a></li>
                ...
                <li><a href="/services"><span class="ion-ios-arrow-round-forward mr-2"></span>Courses</a></li>
                <li><a href="/profile"><span class="ion-ios-arrow-round-forward mr-2"></span>Bartender</a></li>
                <li><a href="/apply"><span class="ion-ios-arrow-round-forward mr-2"></span>Apply</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-6 col-lg-4">
  ...
  |Developed by <a href="http://subedisamir.com.np" target="_blank">Samir Subedi</a> 
