...
@extends('layouts.app')
@section('headSection')
<body class="body-img" style="overflow: visible; padding-right:-26px;">
<style>
...
<main>
   ...
   <section class="contact-section">
            ...
            <div class="container">
            <p>   {!! htmlspecialchars_decode($ab->descrip) !!}</p>
	<div class="row">
		<div class="row">
        @foreach($blog as $abc)
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                   data-image="{{ asset('storage/gallery_images/'.$abc->image) }}"
                   data-target="#image-gallery">
                    <img class="img-thumbnail"
                         src="{{ asset('storage/gallery_images/'.$abc->image) }}"
